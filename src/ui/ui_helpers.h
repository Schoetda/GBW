...
void style_as_button(lv_obj_t* object, int32_t width = LV_DISPLAY_SIZE_CONTENT_WIDTH_PX, int32_t height = 80, const lv_font_t* font = &lv_font_montserrat_28);

lv_obj_t* create_button(lv_obj_t* parent, const char* text,
                       lv_color_t bg_color = lv_color_hex(THEME_COLOR_NEUTRAL),
                       int32_t width = LV_DISPLAY_SIZE_CONTENT_WIDTH_PX, int32_t height = 80, 
